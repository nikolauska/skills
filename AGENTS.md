...
test "$(find plugins/niko-skills/skills -mindepth 2 -maxdepth 2 -name SKILL.md | wc -l)" -eq 36  # ON FAIL: inspect the plugin skills tree for missing or extra entrypoints
```
