...
- `base-200`: Darker base color used to create elevation
- `base-300`: Still darker base color used to create elevation
...
11. Use a fixed Tailwind color only when content must remain independent of the theme, such as a chart series with a defined palette.
