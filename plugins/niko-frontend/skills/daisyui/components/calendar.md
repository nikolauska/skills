...
- Use only a calendar library already installed by the project. Do not add a package or CDN runtime dependency unless the user explicitly requests and accepts it
