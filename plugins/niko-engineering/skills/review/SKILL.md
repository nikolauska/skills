...
5. When Correctness, Security, or Tests is selected, build an adversarial matrix from the feature's supported dimensions, then inspect meaningful combinations rather than only the default path:
