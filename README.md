...
| Plugin | Purpose |
| --- | --- |
| `niko-engineering` | Diagnosis, code review, minimal implementation and behavior-preserving simplification, TDD, and handoff |
...
| `niko-product-docs` | Product knowledge and plan review |
